...
/** Type-safe connection configuration for an independent SQL publisher. */
public final class SqlPublisherConfig implements RulePublisherConfig {
	...
	private SqlPublisherConfig(Builder builder) {
	...
	public static final class Builder {
		...
		public SqlPublisherConfig build() {
			return new SqlPublisherConfig(this);
		}
	}
}
